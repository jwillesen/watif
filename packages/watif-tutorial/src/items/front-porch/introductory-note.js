  ...
  verbRead = {
    ...
    action: () => {
      ...
      return (
        <text>
          <pg>
            The note says: "Thank you for watching the house for us while we're away. You can find
            the key in the usual place. Please remember to feed the fish."
          </pg>
          <pg>Oh, that's right! There's a hide-a-key around here somewhere...</pg>
        </text>
      )
    },
  }
