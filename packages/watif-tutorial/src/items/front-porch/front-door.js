...
export class FrontDoor extends Item {
  ...
  verbKnock() {
    ...
    return (
      <text>
        You bang the knocker several times against the door. You can almost feel it echoing through
        the house. No one comes to answer; probably no one is home.
      </text>
    )
  }
