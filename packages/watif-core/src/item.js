...
export default class Item {
  ...
  // current item so its description will be displayed. You can override this to do something else
  // if you want examining an item to do something special.
  verbExamine() {
    this.universe.setCurrentItem(this.id())
  }
  ...
  getItem(itemId) {
    return this.universe.getItem(itemId)
  }
  ...
  getStateOf(itemId) {
    return this.universe.getStateOf(itemId)
  }

  // Set the state of another item.
  setStateOf(itemId, newState) {
    return this.universe.setStateOf(itemId, newState)
  }
